...
func (gw *Gateway) ServeDNS(_ context.Context, w dns.ResponseWriter, r *dns.Msg) (int, error) {
	...
	var ep = k8sctrl.Resources.DNSEndpoint.Lookup(indexKey, clientIP, gw.opts.geoDataFilePath, gw.opts.geoDataFields...)
...
func (gw *Gateway) selfAddress(state request.Request) (records []dns.RR) {
	...
	var ep = k8sctrl.Resources.DNSEndpoint.Lookup(index, net.ParseIP(state.IP()), gw.opts.geoDataFilePath, gw.opts.geoDataFields...)
	m := new(dns.Msg)
	m.SetReply(state.Req)
